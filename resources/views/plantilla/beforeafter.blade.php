                                    ...
                                    <nav class="main-menu navbar-expand-xl navbar-light">
                                        ...
                                        <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                            <ul class="navigation clearfix">
                                                ...
                                                <li class="active"><a href="before-after.html">Before & After</a></li>
                                                <li class="dropdown">
                                                    <a href="#">Blog</a>
                                                    <ul>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="twentytwenty-container">
                                <img src="images/before-after/3.jpg" class="img-fluid w-100" alt="">
                                <img src="images/before-after/4.jpg" class="img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="twentytwenty-container">
                                <img src="images/before-after/5.jpg" class="img-fluid w-100" alt="">
                                <img src="images/before-after/6.jpg" class="img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="twentytwenty-container">
                                <img src="images/before-after/7.jpg" class="img-fluid w-100" alt="">
                                <img src="images/before-after/8.jpg" class="img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="twentytwenty-container">
                                <img src="images/before-after/9.jpg" class="img-fluid w-100" alt="">
                                <img src="images/before-after/10.jpg" class="img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="twentytwenty-container">
                                <img src="images/before-after/11.jpg" class="img-fluid w-100" alt="">
                                <img src="images/before-after/12.jpg" class="img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="twentytwenty-container">
                                <img src="images/before-after/13.jpg" class="img-fluid w-100" alt="">
                                <img src="images/before-after/14.jpg" class="img-fluid w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
